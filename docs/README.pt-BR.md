...
*Reprodução real com legendas de um vídeo de exemplo criado pela DENO. A interface do aplicativo está disponível em inglês e coreano. [Tela da primeira inicialização](assets/preview.png).*
