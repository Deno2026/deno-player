...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> KoreanStrings = new()
    {
        ...
        ["FileAssociationDescription"] = "체크한 확장자를 Windows '연결 프로그램' 목록에 추가합니다. 기본 앱 설정은 Windows 정책에 따라 사용자가 직접 지정해야 합니다.",
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new()
    {
        ...
        ["FileAssociationDescription"] = "Add selected extensions to the Windows 'Open with' list. Windows requires you to set the default app manually.",
