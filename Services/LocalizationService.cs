...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, string> KoreanStrings = new()
    {
        ...
        ["FileAssociationDescription"] = "기본값은 동영상 및 오디오입니다. 확인을 누르면 선택한 확장자가 Windows '연결 프로그램'과 '기본 앱' 후보에 반영됩니다. 더블클릭 기본 앱 지정은 Windows 설정 화면에서 최종 확인이 필요합니다.",
    ...
    private static readonly Dictionary<string, string> EnglishStrings = new()
    {
        ...
        ["FileAssociationDescription"] = "Video and audio are selected by default. Clicking OK adds the selected extensions to the Windows 'Open with' and Default apps lists. You will still need to confirm the default app in Windows settings for double-click access.",
